...
Vtiger_Detail_Js("Potentials_Detail_Js",{
	...
	registerEventsForSaveAttachment : function(){
		jQuery('.select2Dattachment').live('click', function(){
			var recordId = jQuery('#recordId').val();
			var params = {
	            module: 'Potentials',
	            view: 'DesignAttachment',
	            mode: 'design2DAttachmentPopup',
	            designType: '2DDesign',
	            recordId: recordId
	        };
		...
		jQuery('.select3Dattachment').live('click', function(){
			var recordId = jQuery('#recordId').val();
			var params = {
	            module: 'Potentials',
	            view: 'DesignAttachment',
	            mode: 'design3DAttachmentPopup',
	            designType: '3DDesign',
	            recordId: recordId
	        };
	        app.request.post({data: params}).then(function (err, res) {
