...
<div class="details block">
    <div class="lineItemTableDiv">
        <table class="table table-bordered lineItemsTable" style = "margin-top:15px">
            ...
            <th colspan="11" class="lineItemBlockHeader">
            ...
            <tbody>
                <tr>
                    ...
                    {/if}
                    <td>
                    <strong>{vtranslate('LBL_CTGRY',$MODULE)}</strong>
                </td>
                <td>
                    <strong>{vtranslate('LBL_unitss',$MODULE)}</strong>
                </td>
                <td>
                <strong>{vtranslate('LBL_finish_varients',$MODULE)}</strong>
                </td>
                <td>
                <strong>{vtranslate('LBL_length',$MODULE)}</strong>
                </td>
                <td>
                <strong>{vtranslate('LBL_height',$MODULE)}</strong>
                </td>
                    ...
                    {/if}
                    <td>
                    <strong>{vtranslate('LBL_rate_sft',$MODULE)}</strong>
                    </td>
                    <td>
                    <strong>{vtranslate('LBL_finish_sft',$MODULE)}</strong>
                    </td>
                    <td>
                    <strong>{vtranslate('LBL_total_sft',$MODULE)}</strong>
                    </td>
                    <td>
                    <strong>{vtranslate('LBL_unit_amount',$MODULE)}</strong>
                    </td>
                ...
                {foreach key=INDEX item=LINE_ITEM_DETAIL from=$RELATED_PRODUCTS}
                    <tr>
                        ...
                        {if $PRODUCT_VIEWABLE}
                            ...
                            <td><div align = "right">{$LINE_ITEM_DETAIL["height_value$INDEX"]}</div></td>
                        {/if}
                        ...
                        <td><div align = "right">{$LINE_ITEM_DETAIL["untpricee$INDEX"]}</div></td>
                        <td><div align = "right">{$LINE_ITEM_DETAIL["sqfoot$INDEX"]}</div></td>
                        <td><div align = "right">{$LINE_ITEM_DETAIL["totalcost$INDEX"]}</div></td>
                        <td><div align = "right">{$LINE_ITEM_DETAIL["untpricee$INDEX"]}</div></td>
    ...
    <table class="table table-bordered lineItemsTable">
        ...
        {if $MODULE_NAME eq 'Invoice' or $MODULE_NAME eq 'PurchaseOrder' or $MODULE_NAME eq 'Quotes'}
            <tr>
                <td width="83%">
                    {if $MODULE_NAME eq 'Invoice' or $MODULE_NAME eq 'Quotes'}
                        <div align="right">
